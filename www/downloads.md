...
<a href="https://github.com/jolie/jolie/releases/download/v1.12.2/jolie-1.12.2.jar">
<p class="download">Jolie Installer (Stable: 1.12.2)</p>
</a>
</div>
...
installer, and execute <kbd>java -jar jolie-1.12.2.jar</kbd>. The installer may
...
<kbd>sudo java -jar jolie-1.12.2.jar</kbd>.</li>
