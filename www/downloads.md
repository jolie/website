...
<a href="https://github.com/jolie/jolie/releases/download/v1.12.4/jolie-1.12.4.jar">
<p class="download">Jolie Installer (Stable: 1.12.4)</p>
</a>
</div>
...
installer, and execute <kbd>java -jar jolie-1.12.4.jar</kbd>. The installer may
...
<kbd>sudo java -jar jolie-1.12.4.jar</kbd>.</li>
